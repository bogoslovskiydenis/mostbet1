...
const groups = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'home.infoTable.depositBonus', label: 'Deposit bonus (label)', multiline: false },
      { key: 'home.infoTable.depositBonusValue', label: 'Deposit bonus (value)', multiline: false },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'home.promos.sportsBonus.badge', label: 'Sports bonus: Badge', multiline: false },
      { key: 'home.promos.sportsBonus.title', label: 'Sports bonus: Title', multiline: false },
      { key: 'home.promos.sportsBonus.text', label: 'Sports bonus: Text', multiline: true },
      { key: 'home.promos.sportsBonus.cta', label: 'Sports bonus: CTA', multiline: false },
