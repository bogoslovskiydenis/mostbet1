...
.pragmatic__list li + li {
  margin-top: 4px;
}

.pragmatic__list--numbered {
  list-style: decimal;
}

.pragmatic__tableWrapper {
  margin: 16px 0;
  overflow-x: auto;
}
